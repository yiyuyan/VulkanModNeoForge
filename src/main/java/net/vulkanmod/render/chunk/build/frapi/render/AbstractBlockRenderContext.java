...
public abstract class AbstractBlockRenderContext extends AbstractRenderContext {
	protected static final RenderMaterial STANDARD_MATERIAL = VulkanModRenderer.INSTANCE.materialFinder().shadeMode(ShadeMode.VANILLA).find();
	protected static final RenderMaterial NO_AO_MATERIAL = VulkanModRenderer.INSTANCE.materialFinder().shadeMode(ShadeMode.VANILLA).ambientOcclusion(TriState.FALSE).find();
	...
	protected abstract void endRenderQuad(MutableQuadViewImpl quad);
