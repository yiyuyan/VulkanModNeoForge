...
public class MeshImpl {
	...
	//@Override
	public void forEach(Consumer<? super MeshImpl> action) {
	 ...
	 */
	<C extends MeshImpl> void forEach(Consumer<? super C> action, C cursor) {
	...
	@Override
	public <QuadEmitter> void outputTo(QuadEmitter emitter) {
