...
public class MathUtil {
    ...
    public static float transformX(Matrix4f mat, float x, float y, float z) {
        return org.joml.Math.fma(mat.m00(), x, org.joml.Math.fma(mat.m10(), y, org.joml.Math.fma(mat.m20(), z, mat.m30())));
    }

    public static float transformY(Matrix4f mat, float x, float y, float z) {
        return org.joml.Math.fma(mat.m01(), x, org.joml.Math.fma(mat.m11(), y, org.joml.Math.fma(mat.m21(), z, mat.m31())));
    }

    public static float transformZ(Matrix4f mat, float x, float y, float z) {
        return org.joml.Math.fma(mat.m02(), x, org.joml.Math.fma(mat.m12(), y, org.joml.Math.fma(mat.m22(), z, mat.m32())));
    }
    ...
    public static int packTransformedNorm(Matrix3f mat, boolean trustedNormals, float x, float y, float z) {
        ...
        if (!trustedNormals) {
            float scalar = org.joml.Math.invsqrt(org.joml.Math.fma(nx, nx, org.joml.Math.fma(ny, ny, nz * nz)));
            nx = nx * scalar;
            ny = ny * scalar;
            nz = nz * scalar;
        }
    ...
    public static float transformNormX(Matrix3f mat, float x, float y, float z) {
        return org.joml.Math.fma(mat.m00(), x, org.joml.Math.fma(mat.m10(), y, mat.m20() * z));
    }

    public static float transformNormY(Matrix3f mat, float x, float y, float z) {
        return org.joml.Math.fma(mat.m01(), x, org.joml.Math.fma(mat.m11(), y, mat.m21() * z));
    }

    public static float transformNormZ(Matrix3f mat, float x, float y, float z) {
        return org.joml.Math.fma(mat.m02(), x, org.joml.Math.fma(mat.m12(), y, mat.m22() * z));
    }
}
