    ...
    private static void createInstance() {
        ...
        try (MemoryStack stack = stackPush()) {
            ...
            for (IModInfo mod : ModList.get().getMods()) {
                System.out.println(mod.getModId()+" : "+mod.getDisplayName());
            }
...
//        debugCreateInfo.messageType(VK_DEBUG_UTILS_MESSAGE_TYPE_GENERAL_BIT_EXT | VK_DEBUG_UTILS_MESSAGE_TYPE_VALIDATION_BIT_EXT);
    ...
    private static void createSurface(long handle) {
        ...
        try {
            System.out.println("cL: "+Thread.currentThread().getContextClassLoader().getClass().getName());
            try {
                System.out.println(Class.forName("org.lwjgl.vulkan.VK10"));
                System.out.println(Class.forName("org.lwjgl.vulkan.VkInstance"));
